...
appointment9 = Appointment.create(date: Date.tomorrow, comment: "The nurse will show me how to change the bandage", user: diane, doctor: doctor9, appointment_hour: 10, appointment_min: 30, day_half: "AM" )
